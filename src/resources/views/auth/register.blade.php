...
@section('content')
    <div class="container my-10">
        <h2 class="text-center text-3xl lg:text-5xl font-semibold mb-10">Inscription</h2>
        
        <form method="POST" action="{{ route('register') }}" class="lg:grid grid-cols-2 gap-10">
            @csrf
            @method('POST')
            ...
            <button type="submit" class="col-span-2 mb-5 w-full bg-black rounded shadow text-white text-lg lg:text-2xl py-2 hover:bg-gray-900">
                S'inscrire
            </button>
        </form>
    </div>
