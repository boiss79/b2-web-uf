...
@section('content')
    <div class="container my-10">
        ...
        @forelse ($categories as $category)
            ...
            <a href="{{ route('products.category.index', strtolower($category->name)) }}" class="hover:underline text-blue-500 text-lg">Voir toutes les fiches de la catégorie {{$category->name}}</a>
