...
@section('content')
    <div class="container mt-20 mb-10">
        <h2 class="text-center text-3xl lg:text-5xl font-semibold">Des fiches prêtes à l'emploi</h2>

        <div class="my-10">
            <div class="grid lg:grid-cols-2 gap-10">
                <div>
                    <h2 class="text-2xl lg:text-3xl mb-5">Préparez vos examens en toute sérénité</h2>
        ...
        <h2 class="text-center text-3xl lg:text-5xl font-semibold">Nos 3 dernières fiches</h2>
